...
public class WordTextGenerator {
     ...
     */
    public static List<String> buildModel(int order, String fileName, WordMarkovModel model) {
        ...
        List<String> words = Arrays.asList(text.toString().split("[^A-Za-z0-9]+"));
     ...
     */
    public static void generateText(WordMarkovModel model, List<String> seedText, int order, int length) {
        // Use the first order characters of the text as the starting string
        List<String> kgram = new ArrayList<>(seedText);
        ...
        while (outLength < length) {
            ...
            if (!WordMarkovModel.NOWORD.equals(wordToAppend)) {
        ...
        System.out.println(String.join(" ", kgram));
    }
    ...
    public static void main(String[] args) {
        ...
        List<String> seedText = buildModel(order, fileName, markovModel);
